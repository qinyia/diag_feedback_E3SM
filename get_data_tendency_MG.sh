...
#=============================================================
# add MG tendency output - 2022-05-12
#=============================================================
vars=(MPDLIQ,MPDW2I,MPDW2V,QCSEDTEN,PRAO,PRCO,PSACWSO,BERGSO,MPDW2P)
var_list=(MPDLIQ MPDW2I MPDW2V QCSEDTEN PRAO PRCO PSACWSO BERGSO MPDW2P)
var_new_list=(MPDLIQ MPDW2I MPDW2V QCSEDTEN PRAO PRCO PSACWSO BERGSO MPDW2P)
