...
if [[ "${run_id[0]}" == *"back.trig"* ]]; then
    vars=(FISCCP1_COSP,FSDSC,FSNSC,TREFHT,FSNT,FSNTC,FLUT,FLUTC,TS,T,FSDS,FSNS,Q,SOLIN,FSUTOA,FSUTOAC,PSL,PS,CLOUD,CLDLIQ,CLDICE,PRECC,PRECL,U,V,OMEGA,TGCLDCWP,TGCLDIWP,TGCLDLWP,CLDLOW,CLDLOW_CAL,Z3,CLDMED,CLDHGH,RELHUM,LHFLX,SHFLX,SWCF,LWCF,PBLH,DP_MFUP_MAX,SH_MFUP_MAX,FREQZM,CAPE)
    var_list=(FISCCP1_COSP FSDSC FSNSC TREFHT FSNT FSNTC FLUT FLUTC TS T FSDS FSNS Q SOLIN FSUTOA FSUTOAC PSL PS CLOUD CLDLIQ CLDICE PRECC PRECL U V OMEGA TGCLDCWP TGCLDIWP TGCLDLWP CLDLOW CLDLOW_CAL Z3 CLDMED CLDHGH RELHUM LHFLX SHFLX SWCF LWCF PBLH DP_MFUP_MAX SH_MFUP_MAX FREQZM CAPE)
    var_new_list=(FISCCP1_COSP rsdscs rsnsc tas rsnt rsntcs rlut rlutcs ts T rsds rsns Q rsdt FSUTOA FSUTOAC psl ps CLOUD CLDLIQ CLDICE PRECC PRECL U V OMEGA TGCLDCWP TGCLDIWP TGCLDLWP CLDLOW CLDLOW_CAL Z3 CLDMED CLDHGH RELHUM LHFLX SHFLX SWCF LWCF PBLH DP_MFUP_MAX SH_MFUP_MAX FREQZM CAPE)

elif [[ "${run_id[0]}" == *"OutTend"* ]]; then
    vars=(FISCCP1_COSP,FSDSC,FSNSC,TREFHT,FSNT,FSNTC,FLUT,FLUTC,TS,T,FSDS,FSNS,Q,SOLIN,FSUTOA,FSUTOAC,PSL,PS,CLOUD,CLDLIQ,CLDICE,PRECC,PRECL,U,V,OMEGA,TGCLDCWP,TGCLDIWP,TGCLDLWP,CLDLOW,CLDLOW_CAL,Z3,CLDMED,CLDHGH,RELHUM,LHFLX,SHFLX,SWCF,LWCF,PBLH,DP_MFUP_MAX,SH_MFUP_MAX,FREQZM,CAPE,dCAPE)
    var_list=(FISCCP1_COSP FSDSC FSNSC TREFHT FSNT FSNTC FLUT FLUTC TS T FSDS FSNS Q SOLIN FSUTOA FSUTOAC PSL PS CLOUD CLDLIQ CLDICE PRECC PRECL U V OMEGA TGCLDCWP TGCLDIWP TGCLDLWP CLDLOW CLDLOW_CAL Z3 CLDMED CLDHGH RELHUM LHFLX SHFLX SWCF LWCF PBLH DP_MFUP_MAX SH_MFUP_MAX FREQZM CAPE dCAPE)
    var_new_list=(FISCCP1_COSP rsdscs rsnsc tas rsnt rsntcs rlut rlutcs ts T rsds rsns Q rsdt FSUTOA FSUTOAC psl ps CLOUD CLDLIQ CLDICE PRECC PRECL U V OMEGA TGCLDCWP TGCLDIWP TGCLDLWP CLDLOW CLDLOW_CAL Z3 CLDMED CLDHGH RELHUM LHFLX SHFLX SWCF LWCF PBLH DP_MFUP_MAX SH_MFUP_MAX FREQZM CAPE dCAPE)

else
    vars=(FISCCP1_COSP,FSDSC,FSNSC,TREFHT,FSNT,FSNTC,FLUT,FLUTC,TS,T,FSDS,FSNS,Q,SOLIN,FSUTOA,FSUTOAC,PSL,PS,CLOUD,CLDLIQ,CLDICE,PRECC,PRECL,U,V,OMEGA,TGCLDCWP,TGCLDIWP,TGCLDLWP,CLDLOW,CLDLOW_CAL,Z3,CLDMED,CLDHGH,RELHUM,LHFLX,SHFLX,SWCF,LWCF,PBLH,DP_MFUP_MAX,SH_MFUP_MAX)
    var_list=(FISCCP1_COSP FSDSC FSNSC TREFHT FSNT FSNTC FLUT FLUTC TS T FSDS FSNS Q SOLIN FSUTOA FSUTOAC PSL PS CLOUD CLDLIQ CLDICE PRECC PRECL U V OMEGA TGCLDCWP TGCLDIWP TGCLDLWP CLDLOW CLDLOW_CAL Z3 CLDMED CLDHGH RELHUM LHFLX SHFLX SWCF LWCF PBLH DP_MFUP_MAX SH_MFUP_MAX)
    var_new_list=(FISCCP1_COSP rsdscs rsnsc tas rsnt rsntcs rlut rlutcs ts T rsds rsns Q rsdt FSUTOA FSUTOAC psl ps CLOUD CLDLIQ CLDICE PRECC PRECL U V OMEGA TGCLDCWP TGCLDIWP TGCLDLWP CLDLOW CLDLOW_CAL Z3 CLDMED CLDHGH RELHUM LHFLX SHFLX SWCF LWCF PBLH DP_MFUP_MAX SH_MFUP_MAX)
fi


##=============================================================
## add tendency output - 2022-02-23
##=============================================================
#vars=(FISCCP1_COSP,FSDSC,FSNSC,TREFHT,FSNT,FSNTC,FLUT,FLUTC,TS,T,FSDS,FSNS,Q,SOLIN,FSUTOA,FSUTOAC,PSL,PS,CLOUD,CLDLIQ,CLDICE,PRECC,PRECL,U,V,OMEGA,TGCLDCWP,TGCLDIWP,TGCLDLWP,CLDLOW,CLDLOW_CAL,Z3,DPDLFLIQ,DPDLFICE,DPDLFT,TTEND_CLUBB,RCMTEND_CLUBB,RIMTEND_CLUBB,RVMTEND_CLUBB,TTGWORO,DTCORE,EVAPTZM,EVAPQZM,ZMDT,ZMDQ,ZMDLIQ,ZMDICE,ZMMTT,FZSNTZM,EVSNTZM,PTTEND,PTEQ,PTECLDLIQ,PTECLDICE,DTCOND,DCQ,DCCLDLIQ,DCCLDICE,TTEND_TOT,MPDT,MPDQ,MPDLIQ,MPDICE,EVAPSNOW,EVAPPREC,QISEVAP,QCSEVAP,QIRESO,QCRESO,PSACWSO,PRACSO,MPDW2I,MNUCCRO,CMEIOUT,BERGSO,MELTSDT,FRZRDT,QRL,QRS)
