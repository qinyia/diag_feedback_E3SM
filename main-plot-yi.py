...
#cases = ['v1_amip4K','v1_coupled']
#ref_casesA = [[],['v1_amip4K']]

#cases = ['v1_amip4K','F2010-p4Ka.v1','F2010-p4Ka.v2','F2010-p4Ka.v2.Allv1nml']
#ref_casesA = [[],['v1_amip4K'],['F2010-p4Ka.v1'],['F2010-p4Ka.v1','F2010-p4Ka.v2']]

### remember to turn on Add_otherCMIPs if you want to generate the nice paper plot for RadKernel_globalmean.
#cases = ['v1_coupled','v2_coupled','F2010-p4Ka.v1','F2010-p4Ka.v2']
#ref_casesA = [[],['F2010-p4Ka.v2'],[],['v2_coupled']]

#cases = ['v1_coupled','F2010-p4Ka.v1']
#ref_casesA = [['F2010-p4Ka.v1'],['v1_coupled']]

#cases = ['F2010-p4Ka.v1']
#ref_casesA = [[]]

cases = ['v1_coupled','v1','v1.SSTv1']
ref_casesA = [[],[],['v1_coupled','v1']]

#cases = ['v1','v1_coupled','v1.SSTv1','v1.SSTv1.150yr']
#ref_casesA = [[],[],[],['v1.SSTv1','v1']]

#cases = ['F2010-p4Ka.v1','v1.SSTv1']
#ref_casesA = [[],['F2010-p4Ka.v1']]

#cases = ['F2010-p4Ka.v1','F2010-p4Ka.v2']
#ref_casesA = [[],['F2010-p4Ka.v1']]

#cases = ['F2010-p4Ka.v1','F2010-p4Ka.v2','F2010-p4Ka.v2.Allv1nml']
#ref_casesA = [[],[],['F2010-p4Ka.v1']]

#cases = ['F2010-p4Ka.v1','F2010-p4Ka.v2','F2010-p4Ka.v2.Allv1nml','F2010-p4Ka.v2.Allv1nml.ipdf','F2010-p4Ka.v2.Allv1nml.ipdf.gwenergy']
#ref_casesA = [[],[],[],['F2010-p4Ka.v1','F2010-p4Ka.v2.Allv1nml'],['F2010-p4Ka.v1','F2010-p4Ka.v2.Allv1nml.ipdf']]

#cases = ['F2010-p4Ka.v1','F2010-p4Ka.v2','v2.bk.clubb']
#ref_casesA = [[],[],['F2010-p4Ka.v1','F2010-p4Ka.v2']]

#cases = ['F2010-p4Ka.v1','F2010-p4Ka.v2','v2.bk.clubb','v2.bk.clubb.MG']
#ref_casesA = [[],[],[],['F2010-p4Ka.v1','F2010-p4Ka.v2','v2.bk.clubb']]

#cases = ['F2010-p4Ka.v1','F2010-p4Ka.v2','v2.bk.clubb','v2.bk.clubb.trig','v2.bk.clubb.trig.MG']
#ref_casesA = [[],[],[],[],['F2010-p4Ka.v1','F2010-p4Ka.v2','v2.bk.clubb','v2.bk.clubb.trig']]
#

#cases = ['F2010-p4Ka.v1','F2010-p4Ka.v2','v2.bk.clubb','v2.bk.clubb.MG','v2.bk.clubb.MG.ZM','v2.bk.clubb.MG.ZM.gust','v2.bk.clubb.MG.ZM.gust.trig','v2.bk.clubb.MG.ZM.gust.trig.gw','v1.All']
#ref_casesA = [['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2']]
#ref_casesA = [[],['F2010-p4Ka.v1'],['F2010-p4Ka.v1'],['F2010-p4Ka.v1'],['F2010-p4Ka.v1'],['F2010-p4Ka.v1'],['F2010-p4Ka.v1'],['F2010-p4Ka.v1'],['F2010-p4Ka.v1']]


#cases = ['v1_coupled','v2_coupled','F2010-p4Ka.v1','F2010-p4Ka.v2','v2.bk.clubb','v2.bk.clubb.MG','v2.bk.clubb.MG.ZM','v2.bk.clubb.MG.ZM.gust','v2.bk.clubb.MG.ZM.gust.trig','v2.bk.clubb.MG.ZM.gust.trig.gw','F2010-p4Ka.v2.Allv1nml.ipdf.gwenergy']
#ref_casesA = [[],[],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2'],['F2010-p4Ka.v1','F2010-p4Ka.v2']]

#cases = ['F2010-p4Ka.v1','F2010-p4Ka.v2','v2.bk.clubb','v2.bk.clubb.trig']
#ref_casesA = [[],[],[],['F2010-p4Ka.v1','F2010-p4Ka.v2','v2.bk.clubb']]

#cases = ['F2010-p4Ka.v1','F2010-p4Ka.v2','v2.bk.trig']
#ref_casesA = [[],[],['F2010-p4Ka.v1','F2010-p4Ka.v2']]

#cases = ['v2_coupled','v2.NARRM.coupled']
#ref_casesA = [[],['v2_coupled']]

#cases = ['v2_coupled','F2010-p4Ka.v2','v2.SSTv2']
#ref_casesA = [[],[],['v2_coupled','F2010-p4Ka.v2']]

#cases = ['F2010-p4Ka.v1','v1_coupled']
#ref_casesA = [[],['F2010-p4Ka.v1']]

#cases = ['F2010-p4Ka.v2','v2_coupled']
#ref_casesA = [[],['F2010-p4Ka.v2']]

#cases = ['F2010-p4Ka.v1', 'v1.pert1e-14']
#ref_casesA = [[], ['F2010-p4Ka.v1']]

#cases = ['v2','v1.All']
#ref_casesA = [['v1.All'],['v2']]
...
#'cal_regionCor',            # calculate the regional correspondence (spatial correlation, NRMSE) among cases
]
...
if True:
    ...
    dics_plots = AP.get_plot_dics(cases,ref_casesA,Add_otherCMIPs,datadir_v2, datadir_v1, s1, s2, fh, fh1, a1, colors, figdir, ncase, linestyles, linewidths,Add_amipFuture,highlight_CESM2,lw_CESM2, ls_CESM2, lc_CESM2, datadir_Ringer, datadir_RadKernel, datadir_CldRadKernel,regions)
