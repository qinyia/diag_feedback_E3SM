...
run_id1s = ['cori-haswell.20190513.F2010C5-CMIP6-LR.ne30_oECv3']
# set the p4K case names
run_id2s = ['cori-haswell.20190513.F2010C5-CMIP6-LR.plus4K.ne30_oECv3']
...
for icase,case in enumerate(case_stamp):
    ...
    if RadKernel:
        result = RK.RadKernel(RadKernel_dir,direc_data,case_stamp[icase],yearS,yearE,run_id1,run_id2,outdir_final,figdir)
